...
#include<time.h>
#include <float.h>
#define r 301       //z jakiego zakresu losuje liczby                              mocno wydluza czas               wielkosc kosci
#define n 700         //ile liczb losuje (dla jednego pi, wewnatrz tablicy)                                        ilosc rzutow
#define t 100        //przez ile cykli
int main()
{
srand(time(0));

float a,b,at,bt,a2,b2;
int a1,b1;
int i=0,j=0;
int k=0;
int m=0;
